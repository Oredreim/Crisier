...
@export var database_file_path = "res://src/scripts/json/data_base/FakeDatabase.json"
@export_file("*.tscn") var quiz_screen_scene_path = "res://src/scenes/ui/Menu/multiplayer/quiz/quiz_screen_server.tscn"
