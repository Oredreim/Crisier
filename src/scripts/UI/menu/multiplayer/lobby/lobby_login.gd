...
@onready var user_line_edit = $User_line_edit
@onready var password_line_edit = $Passwrod_line_edit
@onready var error_label = $Erro_label
@onready var login_button = $Login_button
@onready var start_button = $Start_button
@onready var logged_players_label = $Logged_players_colorRect/Label
...
func _on_user_line_edit_text_submitted(new_text):
...
func _on_passwrod_line_edit_text_submitted(new_text):
